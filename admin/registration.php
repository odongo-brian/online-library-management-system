...
<body>
                ...
                <div class="d-flex align-items-center justify-content-center">
                    <form action="" method="post" name="registrationform">
                        ...
                        <p><a href=""class="text-decoration-none">Forgot password?</a> <br>
                            Already Registered? <a href="admin_login.php" class="text-decoration-none">Login</a>
                        </p>
                    </form>
                </div>
            </div>
    ...
    <?php
        if(isset($_POST['registerbtn'])){
            ...
            $phone = $_POST['phone'];
            if($count == 0 ){
                $sql = "INSERT INTO `admin` VALUES('', '$fName', '$lName', '$userName', '$password', '$email', '$phone', 'brian.jpg' )";
                $query = mysqli_query($conn, $sql) or die("failed to insert Admin Details");
